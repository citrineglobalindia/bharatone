    ...
    <section id="home" className="relative pt-12 pb-20 md:pt-20 md:pb-28 overflow-hidden bg-gradient-hero">
      ...
      <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center relative">
        <div>
          ...
          >
            <Button size="lg" onClick={() => { window.location.href = "https://app.mybharatone.com/get-started"; }} className="bg-gradient-saffron text-primary-foreground shadow-soft hover:shadow-glow transition-shadow group">
